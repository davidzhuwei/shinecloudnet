...
import (
	...
	dclcommon "github.com/shinecloudfoundation/shinecloudnet/x/distribution/client/common"
	distrrest "github.com/shinecloudfoundation/shinecloudnet/x/distribution/client/rest"
	disttypes "github.com/shinecloudfoundation/shinecloudnet/x/distribution/types"
...
func TestValidators(t *testing.T) {
	...
	require.Contains(t, resultVals.Validators[0].Address.String(), "scloudvalcons")
	require.Contains(t, resultVals.Validators[0].PubKey, "scloudvalconspub")
