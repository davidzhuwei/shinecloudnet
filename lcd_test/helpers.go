...
import (
	...
	bapp "github.com/shinecloudfoundation/shinecloudnet/app"
)
...
func defaultGenesis(config *tmcfg.Config, nValidators int, initAddrs []sdk.AccAddress, minting bool) (
	...
	if minting {
		...
		mintData.Params.UnfreezeAmountPerBlock = 0
	}
...
// NOTE: If making updates here also update cmd/scloud/cmd/bscloudcli/main.go
