...
import (
	...
	authsim "github.com/shinecloudfoundation/shinecloudnet/x/auth/simulation"
	"github.com/shinecloudfoundation/shinecloudnet/x/bank"
	distr "github.com/shinecloudfoundation/shinecloudnet/x/distribution"
	distrsim "github.com/shinecloudfoundation/shinecloudnet/x/distribution/simulation"
	...
	paramsim "github.com/shinecloudfoundation/shinecloudnet/x/params/simulation"
	"github.com/shinecloudfoundation/shinecloudnet/x/simulation"
	"github.com/shinecloudfoundation/shinecloudnet/x/slashing"
	slashingsim "github.com/shinecloudfoundation/shinecloudnet/x/slashing/simulation"
	"github.com/shinecloudfoundation/shinecloudnet/x/staking"
	stakingsim "github.com/shinecloudfoundation/shinecloudnet/x/staking/simulation"
...
func getSimulateFromSeedInput(tb testing.TB, w io.Writer, app *ShineApp) (
...
func testAndRunTxs(app *ShineApp) []simulation.WeightedOperation {
	cdc := MakeCodec()
...
func invariants(app *ShineApp) []sdk.Invariant {
...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/cosmos/cosmos-sdk/ShineApp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
func BenchmarkFullAppSimulation(b *testing.B) {
	...
	app := NewShineApp(logger, db, nil, true, 0)
...
func TestFullAppSimulation(t *testing.T) {
	...
	app := NewShineApp(logger, db, nil, true, 0, fauxMerkleModeOpt)
	require.Equal(t, "ShineApp", app.Name())
...
func TestAppImportExport(t *testing.T) {
	...
	newApp := NewShineApp(log.NewNopLogger(), newDB, nil, true, 0, fauxMerkleModeOpt)
...
func TestAppSimulationAfterImport(t *testing.T) {
	...
	newApp := NewShineApp(log.NewNopLogger(), newDB, nil, true, 0, fauxMerkleModeOpt)
	require.Equal(t, "ShineApp", newApp.Name())
